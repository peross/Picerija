...
using Picerija.Properties;
using Picerija.Upotreba.Liste;
using Picerija.Upotreba.ToolTipSlika;
using System;
...
{
    public partial class frmUpravljajArtiklima : frmTema
    {
        SqlConnection con = new SqlConnection("Data Source=DESKTOP-IVCH0L3;Initial Catalog=Prodaja;Integrated Security=True");
        SqlCommand cmd = new SqlCommand();
        public frmUpravljajArtiklima()
        {
            InitializeComponent();
            //slikaToolTip
            ToolTipSlika.SlikaToolTip toolTip = new ToolTipSlika.SlikaToolTip();
        ...
        private void frmUpravljajArtiklima_Load(object sender, EventArgs e)
        {
            ucitajPodatkeUdgv();
        }
        ...
        private void btnMeksicka_Click(object sender, EventArgs e)
        {
            con.Open();
        ...
        private void btnPicaSpecial_Click(object sender, EventArgs e)
        {
            con.Open();
