...
namespace Picerija.Upotreba.ToolTipSlika
{
    public partial class ToolTipSlika : Control
    {
        public ToolTipSlika()
        {
            InitializeComponent();
        }
        internal class SlikaToolTip : ToolTip
        {
            #region Constants

            private const int TOOLTIP_WIDTH = 200;
            private const int TOOLTIP_HEIGHT = 100;
